...
class SoundManager {
	private static inline var ADDED:String = Event.ADDED;
	private static inline var REMOVED:String = Event.REMOVED;
	...
	**/
	public static function setSFXVolume(volume:Float, panning:Float):Void {
	...
	**/
	public static function getSFXVolume(volume:Float):Float {
